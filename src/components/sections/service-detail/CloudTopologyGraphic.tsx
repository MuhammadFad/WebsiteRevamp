...
export const CloudTopologyGraphic: React.FC<CloudTopologyGraphicProps> = ({
  ...
  return (
    <div className="relative w-full h-full flex flex-col justify-between p-4 sm:p-5 select-none overflow-hidden bg-[#0B1221]">
      {/* Ambient background glows */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[340px] h-[340px] bg-[#14B8A6]/15 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="relative z-10 flex items-center justify-between px-3.5 py-2 rounded-xl bg-[#0F1D32]/80 border border-[#14B8A6]/30 backdrop-blur-md">
        <div className="flex items-center gap-2">
          ...
          <span className="ml-2 font-mono text-[10px] font-semibold tracking-wider text-[#94A3B8]">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-mono text-[10px] font-bold text-[#14B8A6]">
            48.2k req/s
          </span>
        </div>
      </div>
        ...
        >
          <defs>
            ...
            <linearGradient id="cloudNodeBg" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#0C1E2F" />
          ...
          <g transform="translate(80, 55)">
            <circle r="25" fill="#14B8A6" fillOpacity="0.1" />
            <circle
              r="22"
            ...
            <text
              ...
              y="-28"
              textAnchor="middle"
              className="font-mono text-[9px] font-bold fill-[#E2E8F0]"
            >
              EDGE ANYCAST
            </text>
            <text
              ...
              y="33"
              textAnchor="middle"
              className="font-mono text-[8px] font-medium fill-[#14B8A6]"
            >
              P99: 4.2ms
            </text>
          </g>
          ...
          <g transform="translate(220, 140)">
            ...
            <text
              ...
              y="-36"
              textAnchor="middle"
              className="font-mono text-[10px] font-bold fill-[#FFFFFF]"
            >
              K8S CONTROL PLANE
            </text>
            <text
              ...
              y="44"
              textAnchor="middle"
              className="font-mono text-[8px] font-bold fill-[#14B8A6]"
            >
              AUTO-SCALE (48 PODS)
            </text>
          </g>
      ...
      <div className="relative z-10 pt-2 border-t border-[#14B8A6]/20">
        <div className="grid grid-cols-3 gap-2 py-2 px-3 rounded-xl bg-[#0F1D32]/90 border border-[#14B8A6]/30 backdrop-blur-md">
          <div className="text-center">
            <span className="block font-mono text-[8px] uppercase tracking-wider text-[#94A3B8]">
              P99 Latency
            </span>
            <span className="font-mono text-[12px] font-bold text-[#14B8A6]">
              11.4ms
            </span>
          </div>
        ...
        {activeBadgeText && (
          <div className="mt-2.5 flex justify-center">
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#0B1221]/90 border border-[#14B8A6]/50 backdrop-blur-md shadow-md">
              <span className="w-1.5 h-1.5 rounded-full bg-[#14B8A6] animate-pulse" />
              <span className="font-['Plus_Jakarta_Sans',sans-serif] font-bold text-[10px] uppercase tracking-wider text-[#14B8A6]">
                {activeBadgeText}
              </span>
            </div>
          </div>
