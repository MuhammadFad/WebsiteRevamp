...
const floatingDots = [
  ...
  { id: 'dot-2', left: '20%', top: '65%', size: 5, color: '#14B8A6', glow: 'rgba(20, 184, 166, 0.85)', duration: 7.2, delay: 1 },
  ...
  // Between 02 and 03
  { id: 'dot-6', left: '59%', top: '24%', size: 6.5, color: '#14B8A6', glow: 'rgba(20, 184, 166, 0.9)', duration: 7.8, delay: 1.2 },
  { id: 'dot-7', left: '62%', top: '68%', size: 8, color: '#3B82F6', glow: 'rgba(59, 130, 246, 0.95)', duration: 6.8, delay: 0.7 },
  { id: 'dot-8', left: '68%', top: '14%', size: 5.5, color: '#14B8A6', glow: 'rgba(20, 184, 166, 0.8)', duration: 7.4, delay: 1.4 },
  ...
  { id: 'dot-13', left: '95%', top: '64%', size: 5.5, color: '#14B8A6', glow: 'rgba(20, 184, 166, 0.85)', duration: 7.5, delay: 2.3 },
];

export const ProcessRoadmapSection: React.FC = () => {
  return (
    <section className="relative w-full bg-[#0F172A] py-20 lg:py-[100px] px-6 sm:px-8 lg:px-12 overflow-hidden select-none">
      {/* Background Soft Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[850px] h-[400px] bg-[#14B8A6]/5 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="w-full max-w-[1440px] 2xl:max-w-[1600px] mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          <motion.h2
            ...
            className="font-['Poppins',sans-serif] font-bold text-4xl sm:text-5xl lg:text-[52px] leading-tight text-[#FFFFFF] tracking-tight mb-4"
          >
            The DevLogix Way
          </motion.h2>
          <motion.p
            ...
            className="font-['Poppins',sans-serif] text-[16px] lg:text-[18px] leading-[28px] text-[#94A3B8]"
          >
            A structured approach to chaos. We build, you scale.
          </motion.p>

          {/* Top Decorative Accent Dash from Figma */}
          <div className="w-5 h-[3px] bg-gradient-to-r from-pink-400 to-[#14B8A6] rounded-full mx-auto mt-6 opacity-75 shadow-[0_0_8px_rgba(20,184,166,0.6)]" />
        </div>

        {/* 4 Process Nodes with Chunky Animated Floating Micro-Dots */}
        <div className="relative pt-6 pb-4">
          {/* Connecting Line passing through node centers */}
          <div className="hidden lg:block absolute top-[60px] left-[10%] right-[10%] h-[2px] bg-gradient-to-r from-[#14B8A6]/20 via-[#14B8A6]/60 to-[#14B8A6]/20 z-0" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 relative z-10">
            {processRoadmapData.map((step, index) => (
              ...
              >
                {/* 110x110px Circular Gradient Node: linear-gradient(225deg, #0D938C 25%, #0F172A 75%) */}
                <div className="relative mb-8">
                  {/* Outer subtle halo glow */}
                  <div className="absolute -inset-1.5 rounded-full bg-gradient-to-br from-[#14B8A6]/35 to-transparent blur-md group-hover:blur-lg transition-all duration-300 pointer-events-none" />

                  <div
                    className="relative w-[110px] h-[110px] rounded-full border border-[#14B8A6]/30 flex items-center justify-center shadow-[0_16px_36px_rgba(0,0,0,0.65)] group-hover:scale-105 transition-transform duration-300"
                    style={{
                      background: 'linear-gradient(225deg, #0D938C 25%, #0F172A 75%)',
                    }}
                  >
                ...
                {/* Step Title */}
                <h3 className="font-['Poppins',sans-serif] font-semibold text-[22px] leading-[32px] text-[#FFFFFF] mb-3 group-hover:text-[#14B8A6] transition-colors">
                  {step.title}
                </h3>

                {/* Step Description */}
                <p className="font-['Poppins',sans-serif] font-normal text-[14px] leading-[22px] text-[#94A3B8] max-w-[240px]">
                  {step.description}
                </p>
              </motion.div>
            ))}
          ...
          <div className="w-5 h-[2.5px] bg-[#14B8A6]/70 rounded-full mx-auto mt-16 shadow-[0_0_8px_rgba(20,184,166,0.6)]" />
        </div>
      </div>
    </section>
  );
