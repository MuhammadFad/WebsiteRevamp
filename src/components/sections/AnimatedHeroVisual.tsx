...
export default function AnimatedHeroVisual() {
  return (
    <div className="relative w-full h-[460px] flex items-center justify-center select-none">
      ...
      >
        <div className="w-3 h-3 bg-brand-teal-hover rounded-full absolute -top-1.5 left-1/2 -translate-x-1/2 shadow-[0_0_12px_#14B8A6]" />
      ...
      <motion.div
        ...
        className="relative z-10 w-[360px] h-[360px] rounded-2xl p-[1px] bg-gradient-to-br from-brand-teal-hover/60 via-[#334155]/40 to-transparent shadow-[0_0_50px_rgba(20,184,166,0.15)]"
      >
