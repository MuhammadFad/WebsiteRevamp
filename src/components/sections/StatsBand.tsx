      ...
      <Container className="relative flex flex-col gap-14">
        <Reveal className="flex max-w-3xl flex-col gap-5">
          ...
          <h2 className="text-3xl font-bold tracking-tight text-slate-900 md:text-4xl">
            Partnering in Your <span className="text-brand-teal-dark">AI-First</span> Enterprise
            Transformation
          </h2>
        ...
        <Reveal
          delay={0.1}
          className="grid grid-cols-2 gap-x-8 gap-y-10 md:grid-cols-4 md:divide-x md:divide-slate-200"
        >
          {STATS.map((stat) => (
